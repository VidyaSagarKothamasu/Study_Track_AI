...
try:
    ...
    with right:
        st.markdown('<div class="card-container animate-fade-in"><h3>📌 Cluster Distribution</h3>', unsafe_allow_html=True)
    ...
    # ➕ ASSIGN NEW STUDENT
    with low_right:
        st.markdown('<div class="card-container animate-fade-in"><h3>🎯 Predict Student Cluster</h3>', unsafe_allow_html=True)
        with st.form("new_student_form"):
            ...
            if submitted:
                ...
                st.success(f"Student belongs to: **Cluster {prediction}**")
    ...
    st.success("✅ Click above button to download file")
