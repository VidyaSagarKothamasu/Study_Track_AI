...
c_info1.markdown(f"**Cluster Group:** <span style='color: #c084fc; font-weight: bold;'>Group {cluster}</span>", unsafe_allow_html=True)
...
# AI Chatbot
st.markdown('<div class="card-container animate-fade-in"><h3>🤖 AI Study Assistant</h3>', unsafe_allow_html=True)
...
prompt = st.text_input("Ask a question about your study plan...")
...
if st.button("Query AI"):
    if prompt:
        ...
        st.session_state.messages.append({
            "role": "assistant",
            "content": "Analyzing your cluster patterns... I recommend increasing your Focus sessions by 15% this week."
        })
        st.rerun()
